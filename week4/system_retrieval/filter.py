...
class WaveletFilter(Filter):
    ...
    def filter(self,img):
        ...
        deo_visu = denoise_wavelet(img, method = "VisuShrink", wavelet = 'db1', sigma = sigma_est/2,mode = 'soft', wavelet_levels =4 , multichannel = True, convert2ycbcr = True, rescale_sigma = True)
        
        return (deo_visu* 255).astype('uint8')
